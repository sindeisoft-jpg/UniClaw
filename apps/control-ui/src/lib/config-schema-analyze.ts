/**
 * Config schema normalization for channel config form.
 * Ported from openclaw 2 ui/views/config-form.analyze.ts.
 */

import { pathKey, schemaType, type JsonSchema } from "./config-schema";
