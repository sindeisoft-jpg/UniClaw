...
The Control UI is a **Next.js + React + Tailwind** (V0 stack) app served by the Gateway:
...
different from the HTTP origin. This is handy when you want the Next.js dev server
