...
describe("web monitor inbox", () => {
  ...
  it("locks down when dmPolicy is pairing (unknown senders get pairing reply only)", async () => {
    // Explicit pairing policy => unknown senders blocked, get pairing reply; self still allowed
    mockLoadConfig.mockReturnValue({
