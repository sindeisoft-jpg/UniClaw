...
export type AgentModelEntryConfig = {
  ...
  streaming?: boolean;
  /** Override tool_choice for this model ("auto" | "none" | "required"). Use "required" to force tool use for weaker/smaller models. */
...
/** Default tool choice when calling the model: auto (model may use tools), none (no tools), required (must call a tool). */
...
export type AgentDefaultsConfig = {
  ...
  enableTools?: boolean;
  /** Default tool_choice when calling the model (default: "auto"). */
  toolChoice?: AgentToolChoice;
