...
const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.enableTools": "Enable Tools",
  "agents.defaults.toolChoice": "Tool Choice",
...
const FIELD_HELP: Record<string, string> = {
  ...
  "agents.defaults.models.*.toolChoice":
    'Override tool_choice for this model ("auto", "none", "required"). Use "required" to force tool use for smaller/weaker models.',
  ...
  "agents.defaults.enableTools":
    "Enable tools for agent runs (default: true). Set false for LLM-only mode.",
  "agents.defaults.toolChoice":
    'Default tool_choice when calling the model ("auto", "none", or "required"; default: "auto").',
