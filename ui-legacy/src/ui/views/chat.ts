    ...
    <section class="card chat">
      ...
      <div class="chat-compose">
        <div class="chat-compose__bar">
          ...
          <label class="field chat-compose__field chat-compose__input-wrap">
            <span>消息</span>
            <textarea
          ...
          <div class="chat-compose__footer">
            <div class="chat-compose__pills">
              <button
                type="button"
                class="chat-compose__pill ${props.showThinking ? "active" : ""}"
                ?disabled=${!props.connected}
            ...
            <div class="chat-compose__actions">
              <label class="chat-compose__attach" title="添加图片">
                <input
                  type="file"
                  accept="image/*"
                  multiple
              ...
              <button
                ...
                title=${canAbort ? "停止" : "发送"}
                aria-label=${canAbort ? "停止" : "发送"}
              >
                ${canAbort ? icons.loader : icons.arrowUp}
              </button>
            </div>
          </div>
        </div>
        <p class="chat-compose__disclaimer">内容由 AI 生成，请仔细甄别</p>
      </div>
    </section>
  `;
}
