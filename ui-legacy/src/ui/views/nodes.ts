...
function renderTokenRow(deviceId: string, token: DeviceTokenSummary, props: NodesProps) {
  const status = token.revokedAtMs ? "已撤销" : "有效";
    ...
    <section class="card">
      <div class="row" style="justify-content: space-between; align-items: center;">
        <div>
          ...
          <div class="card-sub">
            在使用 <span class="mono">exec host=node</span> 时将智能体固定到指定节点。
          </div>
        </div>
        <button
          class="btn"
        ...
        state.formMode === "raw"
          ? html`
              <div class="callout warn" style="margin-top: 12px">
                请将配置页切换为<strong>表单</strong>模式以在此编辑绑定。
              </div>
            `
          : nothing
      }
              ...
              <div class="list-item">
                ...
                <div class="list-meta">
                  ...
                  ${
                    !supportsBinding
                      ? html`
                          <div class="muted">暂无支持 system.run 的节点。</div>
                        `
                      : nothing
                  }
                </div>
    ...
    <section class="card">
      <div class="row" style="justify-content: space-between; align-items: center;">
        <div>
          ...
          <div class="card-sub">
            <span class="mono">exec host=gateway/node</span> 的允许列表与审批策略。
          </div>
        </div>
        <button
          class="btn"
    ...
    <div class="list" style="margin-top: 12px;">
      ...
      ${
        state.target === "node" && !hasNodes
          ? html`
              <div class="muted">暂无节点公布执行审批。</div>
            `
          : nothing
      }
    </div>
    ...
    <div class="list" style="margin-top: 16px;">
      ...
      <div class="list-item">
        <div class="list-main">
          ...
          <div class="list-sub">
            ${isDefaults ? "默认询问策略。" : `默认：${defaults.ask}。`}
          </div>
        </div>
        <div class="list-meta">
          <label class="field">
